import { rootLayer, stage, wireLayer } from "../app-renderer.js";
import { setLocation } from "../stage/global.js";
import { deleteIncWire } from "../util/delete.js";
import Pin from "../node/parts/pin.js";
import Socket from "../node/parts/socket.js";
...
export function setWiringRoot(layer) {
    thisRootLayer = layer;
}